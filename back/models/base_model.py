import os, sys
import torch
from .networks import get_grid, resample
#from .warp import imwarp_forward_soft
...
class BaseModel(torch.nn.Module):
    ...
    #    return imwarp_forward_soft(flow, image, False) 
    ...
    def grid_sample(self, input1, input2, method):
        return torch.nn.functional.grid_sample(input1, input2, mode=method, padding_mode='border')#'border'

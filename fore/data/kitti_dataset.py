...
class KittiDataset(BaseDataset):
    ...
    def initialize(self, opt):
        ...
        if opt.only_dynamic is True:
            self.all_image_paths = self.load_all_image_paths('./train_dynamic_kitti_11.5.npy')
        elif opt.only_large is True:
            self.all_image_paths = self.load_all_image_paths('./train_object_kitti_11.5.npy')
        else:
            self.all_image_paths = self.load_all_image_paths('./train_list_kitti.npy')
    ...
    def __getitem__(self, index):
        ...
        masks_paths = self.all_image_paths[index][3]

...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataset', type=str, default='cityscapes', help='choose dataset from cityscapes/kitti/playing for benchmark')                
        self.parser.add_argument('--ImagesRoot', type=str, default='/disk1/yue/cityscapes/cityscapes/leftImg8bit_sequence_512p/')
        ...
        self.parser.add_argument('--SemanticRoot', type=str, default='/disk1/yue/cityscapes/cityscapes/leftImg8bit_sequence_semantic_512p/')
        #'/disk1/yue/cityscapes/cityscapes/leftImg8bit_sequence_semantic/')
        #self.parser.add_argument('--SemanticRoot', type=str, default='/data/yue/cityscapes/leftImg8bit_sequence_semantic/')
        # 512p:
        self.parser.add_argument('--InstanceRoot', type=str, default='/disk1/yue/cityscapes/cityscapes/instance_upsnet/')
        #'/disk1/yue/cityscapes/cityscapes/InstanceMap_256p/'
        self.parser.add_argument('--FlowRoot', type=str, default='/disk1/shared/dataset/cityscapes/cityscapes_2/leftImg8bit_sequence_semantic/')
        self.parser.add_argument('--DynamicRoot', type=str, default='/disk1/yue/Cityscapes-Motion/')
        ...
        self.parser.add_argument('--data_augment',  action='store_true', help='if specified, do resize/random crop/flip data augmentation')
        ...
        self.parser.add_argument('--static', type=bool, default=False, help='whether add static cars to background')  
        # miscellaneous                
